...
const nodes = [ ['router','协调路由 Agent'], ['planner','研究规划 Agent'], ['web_scout','网络调研 Agent'], ['local_scout','本地资料 Agent'], ['judge','证据裁决 Agent'], ['analyst','分析 Agent'], ['reflect','补搜决策 Agent'], ['writer','报告撰写 Agent'], ['validator','引用核验 Agent'] ]
